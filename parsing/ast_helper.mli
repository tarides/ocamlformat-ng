...
module Pat : sig
  ...
  val variant :
    ?loc:loc -> ?attrs:attrs -> label with_loc -> pattern option -> pattern
...
module Exp : sig
  ...
  val parens :
    ?begin_end:bool -> ?loc:loc -> ?attrs:attributes -> expression -> expression
  ...
  val fun_ :
    ...
    arg_label ->
    expression option ->
    pattern option * core_type option ->
    expression ->
    expression
  ...
  val newtype :
    ?loc:loc -> ?attrs:attrs -> loc -> str list -> expression -> expression
...
module Type : sig
  val mk :
    ?loc:loc ->
    ?ext_attrs:str option * attrs ->
    ?attrs:attrs ->
    ?docs:docs ->
    ?text:text ->
    ?params:(core_type * variance_and_inj) list ->
...
module Mty : sig
  ...
  val functor_ :
    ?loc:loc ->
    ?attrs:attrs ->
    functor_parameter with_loc list ->
    module_type ->
    module_type
...
module Md : sig
  val mk :
    ...
    ?text:text ->
    str_opt ->
    functor_parameter with_loc list * module_type ->
    module_declaration
end
...
module Mb : sig
  val mk :
    ...
    ?text:text ->
    str_opt ->
    functor_parameter with_loc list * module_type option * module_expr ->
    module_binding
end
...
module Vb : sig
  val mk :
    ?loc:loc ->
    ?attrs:attrs ->
    ?ext_attrs:string with_loc option * attributes ->
    ?docs:docs ->
    ?text:text ->
    pattern ->
    fun_param list ->
