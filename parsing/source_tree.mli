...
type obj_closed_flag = OClosed | OOpen of Location.t
...
and core_type_desc =
  ...
  | Ptyp_poly of string loc list * core_type
    ...
    *)
  | Ptype_poly of string loc list * core_type (* type a1 ... an. T *)
...
and pattern_desc =
  ...
  | Ppat_construct of Longident.t * (string loc list * pattern) option
    ...
    *)
  | Ppat_list_lit of pattern list (* [ p1 ; p2 ; ... ] *)
  | Ppat_cons of pattern * pattern (* p1 :: p2 *)
  ...
  | Ppat_type of Longident.t (* #tconst *)
...
and expression_desc =
  ...
  | Pexp_construct of Longident.t * expression option
    ...
    *)
  | Pexp_list_lit of expression list (* [ e1 ; e2 ; ... ] *)
  | Pexp_cons of expression * expression (* e1 :: e2 *)
  | Pexp_variant of label loc * expression option
    (* `A             (None)
       `A E           (Some E)
    *)
  | Pexp_record of
      (Longident.t * (core_type option * core_type option) * expression option)
      list
      * expression option
    (* { l1=P1; ...; ln=Pn }     (None)
  ...
  | Pexp_setfield of expression * Longident.t * expression (* E1.l <- E2 *)
  | Pexp_array of expression list (* [| E1; ...; En |] *)
  | Pexp_ifthen of if_branch list (* if E1 then E2 *)
  | Pexp_ifthenelse of if_branch list * expression (* if E1 then E2 else E3 *)
  ...
  | Pexp_letmodule of
      string option loc
      * (functor_parameter loc list * module_type option * module_expr)
      * expression
...
and class_type_field_desc =
  ...
  | Pctf_val of (label loc * mutable_virtual * core_type) (* val x: T *)
...
and with_constraint =
  ...
  | Pwith_module of Longident.t * Longident.t (* with module X.Y = Z *)
  | Pwith_modtype of Longident.t * module_type (* with module type X.Y = Z *)
