...
val pp : ?binder:Parser.token -> ?keyword:Document.t -> t -> Document.t
...
module Module : sig
  type constraint_ = None | Sig of Document.t | Mty of Document.t
  type body = Items of Document.t | Generic of Document.t
